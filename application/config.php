...
return [
    ...
    'view_replace_str'       => [],
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl'  => ROOT_PATH . 'themes' . DS . 'jump.html',
    'dispatch_error_tmpl'    => ROOT_PATH . 'themes' . DS . 'jump.html',
    // +----------------------------------------------------------------------
    // | 异常及错误设置
    // +----------------------------------------------------------------------
    // 异常页面的模板文件
//    'exception_tmpl'         => APP_PATH . 'extra' . DS . 'view' . DS . 'handler.exception.html',
    ...
    //控制器生成路径
    'controllerPath' => APP_PATH.'admin'.DS.'controller'.DS,
    //视图生成路径
    'viewPath' => ROOT_PATH.'themes'.DS.'admin'.DS,
    //排除权限
    'no_auto'   => array(
        'install/index/index',
        'install/index/step1',
